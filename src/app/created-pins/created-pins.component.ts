...
@Component({
  selector: 'app-created-pins',
  templateUrl: './created-pins.component.html',
  styleUrls: ['./created-pins.component.scss']
})
export class CreatedPinsComponent {
  ...
  ngOnInit() {
    this.profile.createdPins(this.userId).subscribe(
      (response: any[]) => {
